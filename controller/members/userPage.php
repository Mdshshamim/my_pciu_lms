...
<html>
	<head>
		...
		<link rel= "shortcut icon" type="image/png" href="../../pic/favcon.png"/>
	</head>
	<body>
		<div class="container">
			<div class="header">
			...
			<div class="userContainer">
				...
				<div class="userContent">
					...
					//ISSUE BOOK...
						...
						{ //if click on issue button..
							...
							{ //checks that both fields is not empty..
	                            ...
	                            if($issueBookId == $result1['bookId'] && $issuerId == $result2['id'])
					...
					//RETURN BOOK...
						...
						if(isset($_REQUEST['returnBtn']))
						{//checks that return button is clicked or not...

	                        $returnId = $_REQUEST['returnId'];
	                        $returnBookId = $_REQUEST['returnBookId'];

	                        if(!empty($returnId) && !empty($returnBookId))
							{ //checks that both fields are filled or not...
	                            ...
	                            if($returnId == $result1['issueId'] && $returnBookId == $result1['bookId'])
