...
<html>
	...
	<body>
		...
		<div class="containerDashboard">
			...
			<div class="tile">Total Book : <br> <?php echo $result2['count(bookId)']; ?>
			</div>

			<div class="tile">Total Faculty : <br> <?php echo $result3['count(id)']?>
			</div>			

			<div class="tile">Total Publishers: <br> <?php echo $result4; ?>
			</div>

			<div class="tile">Price of all books: <br> <?php echo $result5['sum(price)']; ?>
			</div>

			<div class="tile">Books in library: <br> <?php echo $result6['count(bookId)']; ?>
			</div>
