<?php
	...
	$user_data = mysqli_query($con,"SELECT * FROM members WHERE username = '$username'");
...
<html>
	...
	<body>
		<div class="userContainer">
			...
			<div class="userWelcome">Welcome : <?php echo $_SESSION['username']; ?>
			</div>

			<div class="logout"><a href="members/userPage.php?activity=logout">Logout</a>
			</div>
